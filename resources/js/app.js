...
createInertiaApp({
    ...
    setup({ el, App, props, plugin }) {
        ...
        app.config.globalProperties.formattedDate = window.formattedDate = (val, format) => val ? moment(val).format(format ?? 'DD-MM-YY') : '';
        app.config.globalProperties.formattedDateTime = (val, format) => val ? moment(val).format(format ?? 'DD-M-YY | h:mm a') : '';
